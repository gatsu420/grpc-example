...
var file_common_model_user_proto_rawDesc = string([]byte{
...
var (
	...
	file_common_model_user_proto_rawDescData []byte
)

func file_common_model_user_proto_rawDescGZIP() []byte {
	file_common_model_user_proto_rawDescOnce.Do(func() {
		file_common_model_user_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_common_model_user_proto_rawDesc), len(file_common_model_user_proto_rawDesc)))
	})
...
func file_common_model_user_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_model_user_proto_rawDesc), len(file_common_model_user_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
